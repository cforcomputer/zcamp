...
export const NPC_CATEGORIES = {
  MORDUS_LEGION: {
    ...
    ids: [33866, 33864, 33865],
  },
  OFFICERS: {
    name: "Officers",
    color: "#9932cc", // Purple
    ids: [
      13557, 13654, 13564, 13544, 13573, 13589, 13603, 52475, 13667, 13584,
      13635, 13659, 13615, 13661, 13609, 13538, 13536, 13580, 13622, 13561,
      13541,
    ],
  },
  BELT_COMMANDERS: {
    name: "Belt Commanders",
    color: "#ff8c00", // Orange
    ids: [
      33174, 13602, 13601, 23356, 23355, 13578, 13579, 13588, 23357, 13583,
      23358, 23469, 13660, 13658, 13666, 23471, 23470, 23472, 13665, 13653,
      33164, 13652, 13562, 13560, 13572, 23300, 13563, 23299, 13559, 23301,
      23302, 13556, 33172, 22873, 13535, 13537, 22871, 13542, 13540, 22874,
      22872, 13539, 33173, 13543, 33163, 13633, 23401, 23402, 13606, 13620,
      23400, 13621, 13634, 13614, 23403, 33163,
    ],
  },
};
